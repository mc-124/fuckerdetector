...
本项目使用ESP-IDF v6.0.2，依赖请看`idf_component.yml`

## 引脚
|Pin    |Mode           |Type       |Desc                   |
|-      |-              |-          |-                      |
|GPIO0  |Input,PullUp   |All        |按钮或雷达触发信号
...
|GPIO10 |Input,PullUp   |All        |启动时进入CLI用的引脚
...
## 注意
当因 u8g2 库找不到 driver/gpio.h 而编译失败时，去 ./nixy4__u8g2/CMakeLists.txt，找到 `REQUIRE`，给末尾补上 `esp_driver_gpio`，就像这样：
